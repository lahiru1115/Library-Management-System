...
import SubUI.assistantLibrarianForm;
import db.db;
...
public class assistantLibrarianLogin extends javax.swing.JFrame {

    public assistantLibrarianLogin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Assistant Librarian Login");

        adminLogin.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Assistant Librarian Login", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18), new java.awt.Color(0, 150, 200))); // NOI18N
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        String query = "SELECT * FROM `assistant_librarian` WHERE `username` = ? AND `password` = ?";
        ...
        if (Username.trim().equals(" ")) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    assistantLibrarianForm form = new assistantLibrarianForm();
