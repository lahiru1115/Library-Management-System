...
public class registrarLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        adminLogin.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Registrar Login", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18), new java.awt.Color(0, 150, 200))); // NOI18N
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        String query = "SELECT * FROM `registrar` WHERE `username` = ? AND `password` = ?";
